...
const Hero = () => {
  return (
    <Section
      className="bg-gradient-to-b from-[#003050] to-[#2c3e50] flex-col lg:flex-row flex w-full h-screen bg-cover bg-center bg-no-repeat justify-center items-center pt-15 lg:pt-4"
      id="home"
    >
      ...
      <div className="text-white px-10 space-y-2 max-w-2xl">
        ...
        <span className="text-[1.5rem] lg:text-[2rem] text-center lg:text-left block font-semibold">
          I am a{" "}
          <span className="text-[#3b82f6]" id="skillz">
            Web Developer
          </span>
        </span>
        <span className="text-lg block w-[100%] text-justify lg:text-left text-clip">
        ...
        <div className="flex justify-between w-[100%] max-w-sm items-center">
