...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`w-64 h-64 lg:w-96 lg:h-[460px] lg:rounded-2xl rounded-full overflow-hidden ${isToggled ? "border-gray-400" : "border-gray-600"} border-4 shadow-2xl flex-shrink-0 transition-transform duration-300 hover:scale-105`}
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        >
          <motion.h1
            className={`text-3xl lg:text-5xl text-center lg:text-left font-bold ${isToggled ? "text-gray-800" : "text-gray-200"}`}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
            variants={fadeUp}
          ...
          <motion.div
            className={`text-xl lg:text-3xl text-center lg:text-left font-semibold min-h-[2.5rem] lg:min-h-[3rem] ${isToggled ? "text-gray-800" : "text-gray-200"}`}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
            variants={fadeUp}
        ...
        <motion.p
          className={`text-base lg:text-lg text-justify lg:text-left leading-relaxed ${isToggled ? "text-gray-700" : "text-gray-300"}`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeUp}
        ...
        <motion.p
          className={`text-sm lg:text-base ${isToggled ? "text-gray-700" : "text-gray-400"} text-center lg:text-left font-medium pt-2`}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeUp}
